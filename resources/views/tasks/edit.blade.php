...
<body>
    ...
    <div class="container">
        ...
        <form action="<?php echo url('Tasks/'.$data->id); ?>" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="exampleInputStart" name="sdate" value="{{ old('sdate') }}">
            </div>

            <div class="form-group">
                <label for="exampleInputEnd">End Date</label>
                <input type="date" class="form-control" id="exampleInputEnd" name="edate" value="{{ old('edate') }}">
            </div>
